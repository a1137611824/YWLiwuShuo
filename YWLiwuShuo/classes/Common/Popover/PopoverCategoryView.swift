...
class PopoverCategoryView: UIView {
    ...
    private func createPopoverView(titles:[NSString]) -> UIView {
        let btnWidth = SCREEN_WIDTH / CGFloat(popverBtnColumn)
        ...
        popoverView.frame = CGRectMake(0, -CGRectGetMaxY(cacheSquareCategoryBtns.last!.frame), SCREEN_WIDTH, -CGRectGetMaxY(cacheSquareCategoryBtns.last!.frame))
        return popoverView
    }
